...
Share your whole screen or a single window with everyone in the voice channel.
...
Pick a **quality level** to balance sharpness against bandwidth — handy on slower connections.
...
A channel allows a limited number of **simultaneous shares**, so things stay manageable.
