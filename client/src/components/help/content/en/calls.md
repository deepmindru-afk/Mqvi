...
Call a friend directly — no server or channel needed.
...
Calls connect **directly between you and your friend** (peer-to-peer) for the best quality. If a direct connection isn't possible, they fall back to a relay so the call still goes through — and recover on their own after a brief network blip.
