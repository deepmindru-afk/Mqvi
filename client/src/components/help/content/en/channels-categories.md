...
Channels are where conversations happen; categories keep them organized.
...
**Drag** to reorder channels, **rename** them, or **move** them to another category. (Channel-level permissions are covered under **Roles & Moderation**.)
