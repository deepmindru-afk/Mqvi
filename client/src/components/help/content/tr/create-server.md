...
Sunucu senin kendi alanın — kanallar, üyeler, roller, hepsi.

## Bir tane oluştur

Sunucu eklemek için **+** simgesine tıkla, ona bir **isim** ver ve sesin nasıl barındırılacağını seç:

- **mqvi-hosted** — ses kendiliğinden çalışır, kuracak bir şey yok
- **Self-hosted** — tam kontrol için kendi ses sunucunu (LiveKit) getir (bkz. **Self-Hosting**)
