...
Tam bir mesaj yazmadan yanıt vermenin iki hızlı yolu.

## Bir emoji ile tepki ver
...
> 📸 **Ekran görüntüsü:** birkaç emoji tepkisi olan bir mesaj ve açık tepki seçici.
...
> 📸 **Ekran görüntüsü:** üstünde alıntılanmış orijinali gösteren bir yanıt.

## Düzenle & sil

Kendi mesajlarını her zaman **düzenleyebilir** ya da **silebilirsin** — üzerine gelip eylemleri kullan ya da son mesajını düzenlemek için boş yazma kutusunda yukarı oka bas.
